...
public class EpisodeTests {
    ...
    public void createEpisode() throws ParseException {
        ...
        URI new_episode_location = restTemplate.postForLocation("/episodes?season_id=1", episode);
    ...
    public void updateEpisode() throws ParseException {
        ...
        ResponseEntity<Void> err_response = restTemplate.exchange("/episodes/1", HttpMethod.PUT, new HttpEntity<>(episode), Void.class);
    ...
    public void deleteEpisode() {
        ...
        ResponseEntity<Episode> response = restTemplate.getForEntity("/episodes/1", Episode.class);
        assertThat(response.getStatusCode()).isEqualTo(HttpStatus.NOT_FOUND);
        Season season = restTemplate.getForObject("/seasons/2", Season.class);
        assertThat(season.getEpisodes().size()).isEqualTo(1);
    }
}
